...
import { getFirestore, collection, getDocs, getDoc, query, where } from 'https://www.gstatic.com/firebasejs/9.17.1/firebase-firestore.js';
...
export const getBrands = () => {
    return getDocs(collection(db, 'brands'));
}
